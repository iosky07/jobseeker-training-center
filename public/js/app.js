  ...
  return {
    ...
    deleteItem: function deleteItem() {
      ...
      verifyItem: function verifyItem() {
          ...
          Swal.fire({
              title: 'Verifikasi Data Pembayaran',
              text: "Apakah Anda ingin memverifikasi data pembayaran?",
              icon: 'warning',
              showCancelButton: true,
              confirmButtonColor: '#3085d6',
              cancelButtonColor: '#d33',
      ...
      verifySchedule: function verifySchedule() {
          var _this = this;

          Swal.fire({
              title: 'Verifikasi Data Jadwal Interview',
              text: "Apakah Anda ingin memverifikasi data jadwal ini?",
              icon: 'warning',
              showCancelButton: true,
              confirmButtonColor: '#3085d6',
              cancelButtonColor: '#d33',
              ...
              if (result.isConfirmed) {
                  Livewire.emit('verifySchedule', _this.id);
              }
          });
      },
    ...
    setCallback: function setCallback() {
      Livewire.on('deleteResult', function (result) {
        ...
        Livewire.on('verifyResult', function (result) {
            if (result.status) {
                Swal.fire('Diverifikasi!', result.message, 'success');
            } else {
                Swal.fire('Error!', result.message, 'error');
            }
        });
...
__webpack_require__(/*! C:\xampp\htdocs\jtc_2.0\resources\js\app.js */"./resources/js/app.js");
__webpack_require__(/*! C:\xampp\htdocs\jtc_2.0\resources\css\app.css */"./resources/css/app.css");
module.exports = __webpack_require__(/*! C:\xampp\htdocs\jtc_2.0\resources\css\tailwind.css */"./resources/css/tailwind.css");
