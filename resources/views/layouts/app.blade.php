...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        ...
        <script defer src="{{ asset('stisla/js/modules/cleave.min.js') }}"></script>
{{--        <script src="../node_modules/cleave.js/dist/cleave.min.js"></script>--}}
        ...
        <script defer src="{{asset('vendor/bootstrap-daterangepicker/daterangepicker.js')}}"></script>
        <script defer src="{{asset('vendor/time-picker/bootstrap-timepicker.min.js')}}"></script>
